    ...
    <div>
      ...
      <div className="d3-legend">
        ...
        {showMilestones && currentMode === 'zero' && (
          <>
            <div className="d3-legend-item">
              <div className="d3-legend-color" style={{ background: 'var(--chart-red)' }} />
              里程碑
            </div>
            <div className="d3-legend-item">
              <div className="d3-legend-color" style={{ background: 'var(--chart-red)', opacity: 0.3 }} />
              人類水平參考線
            </div>
          </>
        )}
