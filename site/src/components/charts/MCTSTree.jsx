...
function MCTSTreeInner({
  ...
  useEffect(() => {
    ...
    linkGroup.selectAll('path')
      ...
      .style('fill', 'none')
      .style('stroke', d => d.target.data.selected ? 'var(--chart-blue)' : 'var(--chart-ink-muted)')
    ...
    nodes.append('circle')
      .attr('r', 25)
      .style('fill', d => d.data.selected ? 'var(--chart-blue)' : 'var(--chart-white)')
      .style('stroke', d => {
        if (d.data.selected) return 'var(--chart-blue-dark)';
    ...
    nodes.append('text')
      ...
      .style('fill', d => d.data.selected ? 'var(--chart-white)' : 'var(--chart-ink)')
      .attr('font-size', 11)
    ...
    nodes.append('text')
      .attr('dy', 10)
      .attr('text-anchor', 'middle')
      .style('fill', d => d.data.selected ? 'var(--chart-white)' : 'var(--chart-ink-soft)')
      .attr('font-size', 9)
  ...
  return (
    <div>
      ...
      {selectedNode && (
        <div className="d3-legend" style={{ background: 'var(--chart-stone-white)', padding: '1rem', borderRadius: '4px' }}>
      ...
      <div className="d3-legend">
        <div className="d3-legend-item">
          <div className="d3-legend-color" style={{ background: 'var(--chart-blue)' }} />
          選中路徑
        </div>
        <div className="d3-legend-item">
          <div className="d3-legend-color" style={{ background: 'var(--chart-white)', border: '2px solid var(--chart-ink-muted)' }} />
          其他節點
        </div>
        <div className="d3-legend-item">
