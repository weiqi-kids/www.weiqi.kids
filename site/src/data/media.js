...
export const galleries = {
  carnival: {
    ...
    photos: ['舞台主視覺', '全場大合照', '比賽場地全景', '對弈中的會場', '獎盃', '棋盤上的對局', '對局中的棋子', '工作人員與來賓合影', '圍棋主題花器', '開場吉他演出', '獎盃沿長桌排開，背板寫著圍棋嘉年華', '冠軍與亞軍的保溫瓶，印有好棋寶寶標誌', '獎盃上的好棋寶寶標誌特寫', '孩子的手按在棋盤上，旁邊是黑白棋子', '小棋手伸手落子，桌上擺著黑白棋罐', '小手按下計時棋鐘，棋盤上已有黑白子', '棋盤中腹黑白交錯的局面', '孩子捏起黑子，準備落在棋盤上', '黑白棋子密集接觸的局部', '手指輕放黑子的低角度特寫', '接近終盤的棋盤，黑白子布滿整面', '小手持黑子懸在棋盤上方思考', '打開裝滿白棋的棋罐'],
  },
  taipei: {
    title: '113 年臺北市體育總會全國圍棋公開賽（2024 年 1 月 28 日，蓬萊國小）',
    photos: ['賽前的比賽場地', '頒獎台與獎盃', '計時器與棋罐', '主辦與協辦單位合影', '比賽進行中', '落子特寫', '裁判與工作人員', '賽場上的落子特寫，黑白棋子在棋盤交錯', '開賽前的體育館，棋桌棋具沿中央走道排開', '棋桌成列延伸至舞台，棋鐘與棋罐已就定位', '黃色棋鐘特寫，貼有中華民國圍棋協會標籤', '體育館側面全景，牆上掛出各段組別標示牌', '棋盤上並放的黑白棋罐，背景是整排紅椅凳', '黑白棋罐特寫，蓋上貼著圍棋協會封籤', '舞台上排開的獎盃與賽事主視覺布條', '主視覺布條前一整排等待頒發的獎盃'],
  },
  qingshui: {
