...
path: "/knowledge/ai-go/alphago/puct-formula/"
kind: "knowledge"
order: 16
datePublished: "2024-01-15"
dateModified: "2024-02-22"
keywords: ["PUCT 公式", "AlphaGo", "蒙地卡羅樹搜索", "MCTS", "探索與利用", "UCB1", "多臂賭博機", "強化學習"]
legacySource: "docs/alphago/15-puct-formula.mdx"
sourceVerbatim: true
hero: "ag-puct-formula"
heroAlt: "狐狸吉祥物在岔路口猶豫，左邊是熟悉平坦小路右邊是陌生發光小路"
---
...
<MCTSTree client:visible width={700} height={450} showPUCT={true} interactive={true} cPuct={1.5} />
...
- **下一篇**：[AlphaGo Zero 概述](/knowledge/ai-go/alphago/alphago-zero/) — 從零開始的突破
- **上一篇**：[MCTS 與神經網路的結合](/knowledge/ai-go/alphago/mcts-neural-combo/) — 整體架構
- **相關**：[傳統方法的極限](/knowledge/ai-go/alphago/traditional-limits/) — 為什麼需要新方法
...
<FAQ items={[
  { question: "PUCT 公式中的 Q 值和 U 值分別代表什麼？", answer: "Q(s,a) 是利用項，代表動作的平均價值，反映「這步棋過去的表現」；U(s,a) 是探索項，代表動作的探索價值，反映「這步棋還有多少探索空間」。兩者相加決定最終選擇哪個動作。" },
  { question: "為什麼 AlphaGo 使用 PUCT 而非傳統的 UCB1？", answer: "PUCT 能夠利用 Policy Network 提供的先驗機率，讓搜索從一開始就聚焦在合理的走法上。此外，PUCT 的線性探索衰減比 UCB1 的對數衰減更快收斂，更適合有強先驗的場景。" },
  { question: "c_puct 參數該如何調整？", answer: "c_puct 值較小（如 0.5）更偏向利用已知好棋；較大（如 5）更偏向探索新可能。最佳值取決於網路品質和搜索預算：網路很強時可用較小值，搜索次數多時可用較大值。典型值在 1.0-2.0 之間。" }
]} />
