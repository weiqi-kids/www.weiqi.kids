...
path: "/knowledge/ai-go/alphago/supervised-learning/"
kind: "knowledge"
order: 12
datePublished: "2024-01-15"
dateModified: "2024-02-22"
keywords: ["監督學習", "AlphaGo", "KGS", "交叉熵", "人類棋譜", "深度學習", "圍棋AI", "SGF"]
legacySource: "docs/alphago/11-supervised-learning.mdx"
sourceVerbatim: true
hero: "ag-supervised-learning"
heroAlt: "狸貓吉祥物照著厚厚的棋譜書在棋盤上擺子，狐狸拿著紅筆在旁核對打勾"
---

import EloChart from '~/components/charts/EloChart.jsx';
...
對每個局面，提取 48 個特徵平面（詳見 [輸入特徵設計](/knowledge/ai-go/alphago/input-features/)）：
...
<EloChart client:visible mode="training" width={600} height={350} />
...
詳見 [強化學習入門](/knowledge/ai-go/alphago/reinforcement-intro/) 和 [自我對弈](/knowledge/ai-go/alphago/self-play/)。
...
- **上一篇**：[CNN 與圍棋的結合](/knowledge/ai-go/alphago/cnn-and-go/) — 卷積神經網路如何處理棋盤
- **下一篇**：[強化學習入門](/knowledge/ai-go/alphago/reinforcement-intro/) — 超越人類的關鍵
- **相關主題**：[Policy Network 詳解](/knowledge/ai-go/alphago/policy-network/) — 網路架構的細節
