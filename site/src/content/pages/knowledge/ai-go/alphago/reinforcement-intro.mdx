...
path: "/knowledge/ai-go/alphago/reinforcement-intro/"
kind: "knowledge"
order: 13
datePublished: "2024-01-15"
dateModified: "2024-02-22"
keywords: ["強化學習", "MDP", "策略梯度", "REINFORCE", "價值函數", "AlphaGo", "深度學習", "圍棋AI"]
legacySource: "docs/alphago/12-reinforcement-intro.mdx"
sourceVerbatim: true
hero: "ag-reinforcement-intro"
heroAlt: "狐狸吉祥物走在方格小徑上，踩對亮起並掉下果實踩錯變灰，狸貓在終點揮手"
---
...
這個公式在 [PUCT 公式詳解](/knowledge/ai-go/alphago/puct-formula/) 中會詳細解釋。
...
這正是 AlphaGo 成功的關鍵，我們將在下一篇 [自我對弈](/knowledge/ai-go/alphago/self-play/) 中詳細討論。
...
- **下一篇**：[自我對弈](/knowledge/ai-go/alphago/self-play/) — 為什麼 AI 能透過與自己下棋變強
- **相關**：[Value Network 詳解](/knowledge/ai-go/alphago/value-network/) — 價值函數的神經網路實現
- **進階**：[PUCT 公式詳解](/knowledge/ai-go/alphago/puct-formula/) — 探索與利用的數學公式
