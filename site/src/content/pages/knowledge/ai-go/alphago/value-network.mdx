...
path: "/knowledge/ai-go/alphago/value-network/"
kind: "knowledge"
order: 9
datePublished: "2024-01-15"
dateModified: "2024-02-22"
keywords: ["Value Network", "價值網路", "AlphaGo", "勝率預測", "MCTS", "深度學習", "圍棋AI"]
legacySource: "docs/alphago/08-value-network.mdx"
sourceVerbatim: true
hero: "ag-value-network"
heroAlt: "狐狸吉祥物托著天平，左右盤各放黑白棋子並微微傾斜，下方是下到一半的棋盤"
heroCaption: "秤出目前局面黑白哪一方勝率較高，就是價值網路的工作（示意）"
---
...
詳見 [雙頭網路與殘差網路](/knowledge/ai-go/alphago/dual-head-resnet/)。
...
- **上一篇**：[Policy Network 詳解](/knowledge/ai-go/alphago/policy-network/) — 策略網路如何選擇著法
- **下一篇**：[輸入特徵設計](/knowledge/ai-go/alphago/input-features/) — 48 個特徵平面詳解
- **進階主題**：[MCTS 與神經網路的結合](/knowledge/ai-go/alphago/mcts-neural-combo/) — 完整的搜索流程
