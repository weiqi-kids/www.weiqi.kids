...
path: "/knowledge/ai-go/technical/build-from-scratch/"
kind: "knowledge"
order: 12
...
<p class="key-answer" data-question="如何從零打造一個圍棋 AI？">從零打造圍棋 AI 需要四個核心模組：棋盤與規則邏輯、神經網路（策略頭與價值頭）、蒙地卡羅樹搜索（MCTS），以及自我對弈強化學習訓練循環；本文以簡化版 AlphaGo Zero 架構在 9×9 棋盤上實作，可訓練出達業餘初級棋力的 AI。</p>
...
- [神經網路架構詳解](/knowledge/ai-go/technical/neural-network/) — 更深入的網路設計
- [MCTS 實作細節](/knowledge/ai-go/technical/mcts-implementation/) — 進階搜索技術
- [KataGo 訓練機制解析](/knowledge/ai-go/technical/training/) — 生產級訓練系統
- [關鍵論文導讀](/knowledge/ai-go/technical/papers/) — 理論基礎
