...
path: "/knowledge/ai-go/technical/mcts-implementation/"
kind: "knowledge"
order: 5
datePublished: "2026-02-22"
dateModified: "2026-06-21"
legacySource: "docs/tech/deep-dive/mcts-implementation.md"
sourceVerbatim: true
...
<p class="key-answer" data-question="KataGo 的 MCTS 是如何實作的？">KataGo 的 MCTS 由選擇（Selection）、展開（Expansion）、評估（Evaluation）、回傳（Backpropagation）四步驟循環組成，選擇階段以 PUCT 公式平衡探索與利用，並透過虛擬損失、批次神經網路評估與多執行緒平行化大幅提升搜索效率。</p>
...
- [神經網路架構詳解](/knowledge/ai-go/technical/neural-network/) — 評估函數的來源
- [GPU 後端與優化](/knowledge/ai-go/technical/gpu-optimization/) — 批次推理的硬體優化
- [關鍵論文導讀](/knowledge/ai-go/technical/papers/) — PUCT 公式的理論基礎
