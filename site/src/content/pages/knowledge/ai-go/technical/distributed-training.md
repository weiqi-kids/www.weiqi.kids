...
path: "/knowledge/ai-go/technical/distributed-training/"
kind: "knowledge"
order: 7
datePublished: "2026-02-22"
dateModified: "2026-06-21"
legacySource: "docs/tech/deep-dive/distributed-training.md"
sourceVerbatim: true
...
<p class="key-answer" data-question="KataGo 的分散式訓練架構如何運作？">KataGo 分散式訓練由全球志願者的 Self-play Worker 執行自我對弈並上傳棋譜資料，中央訓練伺服器收集資料後定期訓練出更強模型，再發布給 Worker 繼續對弈，形成持續自我改進的循環。</p>
...
- [參與開源社群](/knowledge/ai-go/technical/contributing/) — 如何貢獻程式碼
- [評估與基準測試](/knowledge/ai-go/technical/evaluation/) — 模型評估方法
