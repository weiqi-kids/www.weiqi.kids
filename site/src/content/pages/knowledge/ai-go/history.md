...
heroCaption: "早期圍棋程式、棋盤局面與冠軍獎盃，串起這段發展歷程"
---
...
<p class="key-answer" data-question="AI 圍棋是如何發展起來的？">圍棋因搜索空間龐大、局面難以評估，長期被視為 AI 最難攻克的遊戲；直到 2015 至 2017 年 DeepMind 的 AlphaGo 突破，圍棋 AI 進入 AlphaGo 時代與其後的 KataGo 開源時代兩大階段。</p>
...
### [AlphaGo 時代（2015-2017）](/knowledge/ai-go/history/alphago-era/)
...
### [KataGo 時代（2019-現在）](/knowledge/ai-go/history/katago-era/)
...
- **[AlphaGo 時代](/knowledge/ai-go/history/alphago-era/)** - 從擊敗職業棋手到超越人類極限
- **[KataGo 時代](/knowledge/ai-go/history/katago-era/)** - 開源 AI 與圍棋的新生態
