...
path: "/knowledge/ai-go/how-it-works/"
kind: "knowledge"
order: 1
...
<p class="key-answer" data-question="圍棋 AI 是如何運作的？">圍棋 AI 的核心是用深度神經網路評估局面與選點，再結合蒙地卡羅樹搜索（MCTS）在約 10^170 種龐大局面中聚焦最有希望的著手，並透過自我對弈不斷產生棋譜來強化自身棋力。</p>
...
- **想更深入 AlphaGo**？→ [AlphaGo 完整解析](/knowledge/ai-go/alphago/)
- **想了解 KataGo 細節**？→ [KataGo 的關鍵創新](/knowledge/ai-go/how-it-works/katago-innovations/)
- **想查特定概念**？→ [概念速查表](/knowledge/interactive/animations/)
- **想動手實作**？→ [30 分鐘跑起第一個圍棋 AI](/knowledge/ai-go/kata-go/hands-on/)
