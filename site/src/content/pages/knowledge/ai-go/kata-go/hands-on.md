...
path: "/knowledge/ai-go/kata-go/hands-on/"
kind: "knowledge"
order: 1
...
<p class="key-answer" data-question="如何在 30 分鐘內跑起第一個圍棋 AI？">只要四個步驟即可在約 30 分鐘內完成：安裝 KataGo（如 macOS 用 Homebrew）、下載神經網路模型、建立設定檔，最後啟動 GTP 模式即可與 AI 對弈並分析每步棋的勝率。</p>
...
- [完整安裝指南](/knowledge/ai-go/kata-go/hands-on/setup/) — 進階設定與編譯
- [基本使用](/knowledge/ai-go/kata-go/hands-on/basic-usage/) — GTP 與 Analysis Engine 詳解
- [整合到你的專案](/knowledge/ai-go/kata-go/hands-on/integration/) — Python/Node.js API
- [一篇文章搞懂圍棋 AI](/knowledge/ai-go/how-it-works/) — 了解技術原理
