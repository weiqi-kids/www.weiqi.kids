...
path: "/knowledge/ai-go/kata-go/hands-on/basic-usage/"
kind: "knowledge"
order: 3
...
<p class="key-answer" data-question="KataGo 有哪兩種操作模式，分別適合什麼用途？">KataGo 提供兩種操作模式：GTP 模式採用標準的 Go Text Protocol，適合人機對弈與棋類軟體串接；Analysis Engine 採用 JSON 格式輸入輸出，適合批次分析與程式整合。</p>
...
- [KataGo 的關鍵創新](/knowledge/ai-go/how-it-works/katago-innovations/) — 了解技術細節
