...
path: "/knowledge/ai/industry/ai-transformation/"
kind: "knowledge"
order: 4
...
heroCaption: "圍棋走過的 AI 轉型歷程，可以套用到其他各行各業（示意）"
---

圍棋界經歷了完整的 AI 轉型歷程，其經驗對其他行業極具參考價值。

<p class="key-answer" data-question="圍棋界的 AI 轉型經驗能給其他行業什麼啟示？">圍棋界走過震驚抗拒、觀望實驗、接受整合到全面融合四個階段，從最初否定 AI 到「沒有 AI 無法訓練」。這個歷程顯示：低估 AI 能力是常態，但及早將 AI 視為輔助工具而非威脅的人，才能在轉型中取得領先。</p>

:::tip[完整簡報下載]
📥 **[從 KataGo 看圍棋 AI 的產業升級啟示（PDF）](https://raw.githubusercontent.com/weiqi-kids/www.weiqi.kids/legacy-docusaurus-final/static/pdf/從%20KataGo%20看圍棋%20AI%20的產業升級啟示.pdf)**
:::
...
- [圍棋 AI 產業現況](/knowledge/ai-go/) — 產業總覽
- [實際應用案例](/knowledge/ai/industry/applications/) — 具體案例
