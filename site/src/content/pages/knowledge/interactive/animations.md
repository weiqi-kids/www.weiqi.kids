...
path: "/knowledge/interactive/animations/"
kind: "knowledge"
order: 1
...
| 系列 | 數量 | 主題 | 難度 |
|------|------|------|------|
| [A 系列](#a-系列資料結構與表示) | 11 | 資料結構與表示 | ⭐ 入門 |
| [B 系列](#b-系列搜尋與樹結構) | 11 | 搜尋與樹結構 | ⭐ 入門 |
| [C 系列](#c-系列蒙地卡羅方法) | 10 | 蒙地卡羅方法 | ⭐⭐ 進階 |
| [D 系列](#d-系列神經網路) | 18 | 神經網路 | ⭐⭐ 進階 |
| [E 系列](#e-系列alphago-架構) | 13 | AlphaGo 架構 | ⭐⭐⭐ 專業 |
| [F 系列](#f-系列縮放) | 8 | 縮放 | ⭐⭐⭐ 專業 |
| [G 系列](#g-系列維度) | 6 | 維度 | ⭐⭐ 進階 |
| [H 系列](#h-系列強化學習) | 9 | 強化學習 | ⭐⭐⭐ 專業 |
| [I 系列](#i-系列博弈論) | 6 | 博弈論 | ⭐⭐ 進階 |
| [J 系列](#j-系列資訊理論) | 6 | 資訊理論 | ⭐⭐⭐ 專業 |
| [K 系列](#k-系列優化方法) | 6 | 優化方法 | ⭐⭐ 進階 |
| [L 系列](#l-系列泛化與穩定) | 5 | 泛化與穩定 | ⭐⭐ 進階 |
| **總計** | **109** | | |
...
- [AlphaGo 完整解析](/knowledge/ai-go/alphago/) — 20 篇深度文章
- [一篇文章搞懂圍棋 AI](/knowledge/ai-go/how-it-works/) — 快速入門
- [KataGo 的關鍵創新](/knowledge/ai-go/how-it-works/katago-innovations/) — 50 倍效率提升
