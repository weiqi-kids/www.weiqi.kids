...
<p class="key-answer" data-question="如何從零開始學圍棋？">先從入門篇打好基礎，學習圍棋規則、基本術語、對弈禮儀與開局十手；再進入 AI 時代篇，認識人工智慧帶來的觀念變化並學會善用 AI 工具輔助進步，循序漸進建立正確觀念與棋力。</p>
...
- [圍棋規則](/knowledge/go/introduction/rules/) - 氣、提子、禁著點、劫、眼與活棋
- [基本術語](/knowledge/go/introduction/terminology/) - 棋盤、下棋、棋形、對局相關用語
- [對弈禮儀](/knowledge/go/introduction/etiquette/) - 下棋的禮節與態度
- [開局十手](/knowledge/go/introduction/first-10-moves/) - 佈局的基本方向與概念

### AI 時代

了解人工智慧如何改變圍棋：

- [AI 帶來的變化](/knowledge/ai/changes/) - 棋風與觀念的轉變
- [用 AI 學棋](/knowledge/ai/learning-with-ai/) - 善用工具輔助進步

## 學習路線圖

```mermaid
flowchart TB
    subgraph stage1["🌱 階段一：打好基礎"]
        A1[學習規則] --> A2[認識術語]
        A2 --> A3[9路/13路練習]
        A3 --> A4[對弈禮儀]
    end

    subgraph stage2["🌿 階段二：建立棋感"]
        B1[開局方向] --> B2[死活練習]
        B2 --> B3[19路實戰]
        B3 --> B4[簡單復盤]
    end

    subgraph stage3["🌳 階段三：系統提升"]
        C1[定式學習] --> C2[形勢判斷]
        C2 --> C3[AI 分析]
        C3 --> C4[職業棋局欣賞]
    end
