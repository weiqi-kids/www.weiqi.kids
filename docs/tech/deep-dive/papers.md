...
<p className="key-answer" data-question="圍棋 AI 有哪些必讀的關鍵論文？">圍棋 AI 發展史上的里程碑論文包括：Coulom 的 MCTS（2006）、AlphaGo（2016）、AlphaGo Zero（2017）、通用化的 AlphaZero（2017），以及 David Wu 提出多項效率改進的 KataGo（2019）；想了解基礎可先讀 AlphaGo，實作參考則以 KataGo 論文為主。</p>
...
- [神經網路架構詳解](../neural-network) — 深入理解網路設計
