...
<p className="key-answer" data-question="如何評估圍棋 AI 的棋力與效能？">評估圍棋 AI 棋力主要採用 Elo 評分系統，透過大量對局計算相對勝率與評分差距，並可搭配 SPRT 等統計方法判斷新模型是否確實更強；效能則以每秒搜索的節點數（visits/playouts）等基準測試衡量。</p>
...
- [KataGo 訓練機制解析](../training) — 模型是如何訓練的
