...
<ArticleSchema
  title="AlphaGo 完整解析"
  description="從歷史背景到技術細節，20 篇文章帶你徹底理解 AlphaGo"
  slug="for-engineers/how-it-works/alphago-explained"
  datePublished="2024-01-15"
  dateModified="2024-02-22"
  section="AlphaGo 完整解析"
  keywords={["AlphaGo", "圍棋 AI", "深度學習", "強化學習", "蒙地卡羅樹搜索", "MCTS", "神經網路", "DeepMind"]}
  wordCount={2000}
/>
...
本系列文章引用了 [109 個動畫概念](/docs/animations/) 中的以下系列：
...
- [KataGo 的關鍵創新](/docs/tech/how-it-works/katago-innovations) — 如何用更少資源達到更強棋力
- [概念速查表](/docs/tech/how-it-works/concepts/) — 概念的完整列表
...
<KeyTakeaway>
本文重點：
- 本系列涵蓋 6 大模組、20 篇深度文章，從歷史背景到技術細節完整解析 AlphaGo
- 核心技術：深度神經網路（Policy + Value Network）+ 蒙地卡羅樹搜索（MCTS）+ 強化學習
- AlphaGo Zero 的突破：不需人類棋譜、從零開始、3 天超越人類，開創「從第一性原理學習」的新範式
</KeyTakeaway>

<FAQ items={[
  { question: "這個系列適合什麼背景的讀者？", answer: "完全新手可從「AlphaGo 的誕生」按順序閱讀；了解圍棋的讀者可從「圍棋為什麼難？」開始；有機器學習基礎的讀者可直接看「Policy Network 詳解」；想快速了解精華可讀「MCTS 與神經網路的結合」。完整閱讀約需 8-10 小時，快速瀏覽約 2-3 小時。" },
  { question: "AlphaGo 的核心技術是什麼？", answer: "AlphaGo 結合三大技術：1）Policy Network 預測下一步落子機率；2）Value Network 評估當前局面勝率；3）蒙地卡羅樹搜索（MCTS）利用這兩個網路進行高效搜索。這個組合讓 AlphaGo 能在龐大的搜索空間中找到好棋。" },
  { question: "AlphaGo 和 AlphaGo Zero 有什麼差別？", answer: "原版 AlphaGo 需要人類棋譜預訓練，使用分離的 Policy/Value 網路，訓練需要 50+ GPU。AlphaGo Zero 完全從零開始自我對弈學習，使用單一雙頭網路，只需 4 TPU 就達到更強棋力。Zero 證明了 AI 不需要人類知識也能超越人類。" }
]} />
