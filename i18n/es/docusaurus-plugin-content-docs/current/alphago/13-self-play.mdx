...
```mermaid
flowchart TB
    PS["Parameter Server<br/>(almacena el θ mas reciente,<br/>recibe actualizaciones de gradiente)"]

    W1["Worker 1<br/>auto-juego<br/>recopilar trayectorias"]
    W2["Worker 2<br/>auto-juego<br/>recopilar trayectorias"]
    WN["Worker N<br/>auto-juego<br/>recopilar trayectorias"]

    W1 -->|"actualizacion de gradiente"| PS
    W2 -->|"actualizacion de gradiente"| PS
    WN -->|"actualizacion de gradiente"| PS

    PS -->|"parametros mas recientes"| W1
    PS -->|"parametros mas recientes"| W2
    PS -->|"parametros mas recientes"| WN
```
