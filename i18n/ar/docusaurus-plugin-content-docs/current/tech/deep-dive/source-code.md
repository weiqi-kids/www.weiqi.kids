...
<p className="key-answer" data-question="كيف يبدو هيكل الكود المصدري لـ KataGo؟">ينقسم الكود المصدري لـ KataGo (github.com/lightvector/KataGo) إلى جزأين رئيسيين: مجلد cpp/ وهو محرك C++ الأساسي ويضم البرنامج الرئيسي وقواعد الغو (game) وبحث MCTS (search) واستدلال الشبكة العصبية (neuralnet)؛ ومجلد python/ وهو كود التدريب بلغة Python ويضم برنامج التدريب الرئيسي وتعريف بنية الشبكة (model.py) ومعالجة البيانات.</p>
