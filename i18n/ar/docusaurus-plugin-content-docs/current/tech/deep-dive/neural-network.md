...
<p className="key-answer" data-question="ما هي بنية الشبكة العصبية في KataGo؟">يعتمد KataGo تصميم شبكة عصبية واحدة بإخراج متعدد الرؤوس: يستخدم برج البقايا (20 إلى 60 كتلة بقايا مع إضافة طبقة تجميع شامل) كعمود فقري لاستخراج الميزات من طبقات ميزات الإدخال، ثم يتفرع إلى أربعة رؤوس إخراج هي Policy (احتمال الوضع) وValue (نسبة الفوز) وScore (فارق النقاط) وOwnership (ملكية المنطقة).</p>
