...
<p className="key-answer" data-question="كيف يُنفَّذ بحث شجرة مونت كارلو (MCTS) في KataGo؟">يتكوّن بحث MCTS في KataGo من دورة من أربع خطوات: الاختيار (Selection)، والتوسيع (Expansion)، والتقييم (Evaluation)، والانتشار العكسي (Backpropagation). تُوازِن مرحلة الاختيار بين الاستكشاف والاستغلال باستخدام صيغة PUCT، ويرفع الكفاءة بشكل كبير عبر الخسارة الافتراضية وتقييم الشبكة العصبية على دفعات والتوازي متعدد الخيوط.</p>
