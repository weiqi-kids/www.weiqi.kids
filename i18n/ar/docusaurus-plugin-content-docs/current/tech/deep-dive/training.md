...
<p className="key-answer" data-question="كيف تعمل آلية تدريب KataGo؟">يعتمد KataGo على التعلّم المعزَّز عبر اللعب الذاتي: يُنتج نموذج أولي عدداً كبيراً من سجلات المباريات عبر اللعب الذاتي، وبعد جمع البيانات يُدرَّب باستخدام دالتي خسارة السياسة والقيمة لإنتاج نموذج أقوى، ثم تتكرر هذه الدورة لتحقيق تقدم مستمر؛ وتزداد ذاكرة GPU والوقت اللازمان للتدريب مع كبر حجم النموذج (مثلاً من b6c96 إلى b40c256).</p>
