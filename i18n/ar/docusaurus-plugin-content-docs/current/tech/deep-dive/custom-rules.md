...
<p className="key-answer" data-question="ما القواعد التي يدعمها KataGo وكيف تخصّصها؟">يدعم KataGo مجموعات قواعد متعددة منها الصينية واليابانية والكورية وAGA والنيوزيلندية وTromp-Taylor، ويمكن تخصيص طريقة العدّ والكومي وأبعاد اللوحة في ملف config.cfg عبر معاملات مثل rules وkomi (الكومي) وboardXSize/boardYSize (حجم اللوحة).</p>
