...
<p className="key-answer" data-question="كيف تحسّن أداء معالج الرسوميات في KataGo؟">يوفّر KataGo أربع واجهات حوسبة هي CUDA وOpenCL وMetal وEigen؛ تحقق CUDA أفضل أداء على معالجات NVIDIA، وتعمل OpenCL عبر مختلف الشركات المصنّعة، وتُستخدم Metal على شرائح Apple Silicon، وEigen على المعالج المركزي فقط. ويتمثل مفتاح التحسين في اختيار الواجهة المناسبة وضبط حجم الدفعة (nnMaxBatchSize) وعدد الخيوط لاستغلال معالج الرسوميات بالكامل.</p>
