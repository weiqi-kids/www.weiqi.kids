...
<p className="key-answer" data-question="كيف تقيّم قوة لعب الذكاء الاصطناعي في الغو وأداءه؟">يُعتمد بشكل رئيسي نظام تقييم Elo لقياس قوة لعب الذكاء الاصطناعي في الغو، إذ يحسب معدل الفوز النسبي وفارق التقييم عبر عدد كبير من المباريات، ويمكن الاستعانة بطرق إحصائية مثل SPRT لتحديد ما إذا كان النموذج الجديد أقوى فعلًا؛ أما الأداء فيُقاس بمعايير مثل عدد العقد المبحوثة في الثانية (visits/playouts).</p>
