...
├─────────────────────────────────────────────────────┤
│                                                     │
│   1. Selection      الاختيار: النزول في الشجرة، استخدام PUCT لاختيار العقد  │
│         │                                           │
│         ▼                                           │
│   2. Expansion      التوسيع: عند الوصول لعقدة ورقة، إنشاء عقد فرعية    │
│         │                                           │
│         ▼                                           │
│   3. Evaluation     التقييم: استخدام الشبكة العصبية لتقييم العقدة الورقة      │
│         │                                           │
│         ▼                                           │
│   4. Backprop       الرجوع: تحديث إحصائيات جميع العقد في المسار    │
│                                                     │
│   التكرار آلاف المرات، اختيار الحركة الأكثر زيارة                │
│                                                     │
└─────────────────────────────────────────────────────┘
```
