...
This article series references the following series from [109 Animation Concepts](../concepts/):
...
- [KataGo's Key Innovations](../katago-innovations) — How to achieve stronger play with fewer resources
- [Concept Quick Reference](../concepts/) — Complete list of 109 animation concepts
- [Run Your First Go AI in 30 Minutes](../../hands-on/) — Hands-on practice
