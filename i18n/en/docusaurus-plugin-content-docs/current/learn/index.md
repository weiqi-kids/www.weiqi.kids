...
- [Go Rules](/docs/learn/introduction/rules) - Liberties, capturing, illegal moves, ko, eyes, and living groups
- [Basic Terminology](/docs/learn/introduction/terminology) - Board, moves, shapes, and game-related terms
- [Game Etiquette](/docs/learn/introduction/etiquette) - Manners and attitude when playing
- [Opening Concepts](/docs/learn/introduction/first-10-moves) - Basic direction and concepts for the opening

### The AI Era

Understanding how artificial intelligence has changed Go:

- [Changes Brought by AI](/docs/learn/ai-era/changes) - Shifts in playing style and concepts
- [Learning with AI](/docs/learn/ai-era/learning-with-ai) - Using tools effectively to improve
