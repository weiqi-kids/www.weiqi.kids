...
1. **Don't just look at "best move"**: Understand why that move is better
2. **Note win rate changes**: See which moves were turning points
3. **Focus on general direction**: Don't obsess over minor differences
