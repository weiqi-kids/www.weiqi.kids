...
1. **Claim key points**: Occupy high-value positions
2. **Establish bases**: Lay foundations for subsequent fighting
3. **Maintain balance**: Balance territory and influence

### Fundamental Go Principle

:::tip Corner, Side, Center
...
1. **Occupy corners** (moves 1-4 approximately)
2. **Approach or defend corners** (moves 5-10)
3. **Claim sides or develop** (after move 10)
...
1. Play one move in each of the four corners (occupy corners)
2. Use star points (4,4) for opening - simpler
3. Don't rush to learn complex joseki
