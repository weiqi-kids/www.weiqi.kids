---
sidebar_position: 1
title: Lightman Chang
description: Lightman Chang (張饒輝 / CΛ) — Founder of the Taiwan Good Go Baby Association, CTO of Medicine Reminder Technology, and founding shareholder of Goer Technology. Specializing in AI / digital health product design, FHIR / SMART on FHIR healthcare interoperability, and Go education.
keywords: [Lightman Chang, 張饒輝, Taiwan Good Go Baby Association, FHIR, SMART on FHIR, digital health, healthcare AI, Go education, AI engineering]
industry_tags: [AI Engineering, Digital Health, Healthcare IT, Go Education, FHIR]
ai_tools: [all]
contributing_role: Domain Knowledge Lead
---
...
<PersonSchema
  name="Lightman Chang"
  alternateName="張饒輝 / CΛ"
  jobTitle="Founder, Taiwan Good Go Baby Association / CTO, Medicine Reminder Technology / Founding Shareholder, Goer Technology"
  description="An integrator working at the intersection of problem analysis, root-cause investigation, method design, systems integration, and knowledge translation. Specializes in AI / digital health product design and FHIR / SMART on FHIR healthcare interoperability, with a long-standing commitment to Go education and structured thinking."
  ...
  knowsAbout={[
    ...
    'SMART on FHIR Application Design',
    'Clinical Workflow & Data Flow Planning',
    'Problem Decomposition & Root-Cause Analysis',
    'Knowledge Translation & Educational Content Design',
    'Go Education & Structured Learning Design',
  ]}
  hasCredential={[
    { name: 'Guangdong Province Junior Go Teacher Certification', category: 'Go Education Credential' },
    { name: 'Online Go Teacher Training — Demonstration Lecture Examination (Trainer-level)', category: 'Go Education Credential' },
  ]}
  worksFor={[
    { name: 'Medicine Reminder Technology Co., Ltd.', url: 'https://www.yao.care' },
    { name: 'Goer Technology Co., Ltd.' },
  ]}
  sameAs={[
    'https://www.yao.care',
...
*Source: agent.writer official persona / profile.json*
