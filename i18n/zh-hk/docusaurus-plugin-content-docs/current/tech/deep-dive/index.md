...
sidebar_position: 1
title: 畀想深入研究嘅人
description: 進階主題導覽：神經網絡、MCTS、訓練、優化、部署
---

# 畀想深入研究嘅人

呢個章節適合想深入研究圍棋 AI 嘅工程師，涵蓋技術實作、理論基礎同實務應用。

<p className="key-answer" data-question="深入研究圍棋 AI 應該由邊啲主題入手？">本章節依四大主題系統整理深入內容：核心技術（神經網絡架構、MCTS 實作、訓練機制）、效能優化（GPU 後端、模型量化部署、評估基準）、進階主題（分散式訓練、自訂規則、關鍵論文）以及開源同實作，適合想深入研究或貢獻圍棋 AI 嘅工程師。</p>
...
| 文章 | 說明 |
|------|------|
| [神經網絡架構詳解](./neural-network) | KataGo 嘅殘差網絡、輸入特徵、多頭輸出設計 |
...
| 文章 | 說明 |
|------|------|
| [GPU 後端與優化](./gpu-optimization) | CUDA、OpenCL、Metal 後端比較同調校 |
...
| 文章 | 說明 |
|------|------|
| [分散式訓練架構](./distributed-training) | Self-play Worker、資料收集、模型發佈 |
...
| 規模 | 建議硬件 | 訓練時間 |
|------|---------|---------|
| 迷你（b6c96） | GTX 1060 6GB | 幾個鐘 |
| 細型（b10c128） | RTX 3060 12GB | 1-2 日 |
| 中型（b18c384） | RTX 4090 24GB | 1-2 個禮拜 |
| 完整（b40c256） | 多 GPU 集群 | 幾個禮拜 |
