...
<p className="key-answer" data-question="點樣評估圍棋 AI 嘅棋力同效能？">評估圍棋 AI 棋力主要採用 Elo 評分系統，透過大量對局計算相對勝率同評分差距，並可配搭 SPRT 等統計方法判斷新模型係咪確實更強；效能則以每秒搜索嘅節點數（visits/playouts）等基準測試衡量。</p>
