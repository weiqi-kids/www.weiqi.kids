...
<p className="key-answer" data-question="KataGo 嘅訓練機制點樣運作？">KataGo 採用自我對弈強化學習：以初始模型大量自我對弈產生棋譜，收集資料之後用策略同價值損失函數訓練更新出更強模型，再重複呢個循環持續進步；訓練所需嘅 GPU 記憶體同時間隨模型規模（如 b6c96 到 b40c256）遞增。</p>
