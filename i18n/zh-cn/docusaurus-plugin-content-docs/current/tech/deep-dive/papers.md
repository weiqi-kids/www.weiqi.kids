...
<p className="key-answer" data-question="围棋 AI 有哪些必读的关键论文？">围棋 AI 发展史上的里程碑论文包括：Coulom 的 MCTS（2006）、AlphaGo（2016）、AlphaGo Zero（2017）、通用化的 AlphaZero（2017），以及 David Wu 提出多项效率改进的 KataGo（2019）；想了解基础可先读 AlphaGo，实现参考则以 KataGo 论文为主。</p>
