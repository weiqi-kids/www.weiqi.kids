...
<p className="key-answer" data-question="如何评估围棋 AI 的棋力与性能？">评估围棋 AI 棋力主要采用 Elo 评分系统，通过大量对局计算相对胜率与评分差距，并可搭配 SPRT 等统计方法判断新模型是否确实更强；性能则以每秒搜索的节点数（visits/playouts）等基准测试来衡量。</p>
