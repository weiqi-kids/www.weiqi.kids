...
```mermaid
flowchart TB
    Server["Parameter Server<br/>(Menyimpan θ terbaru, menerima update gradien)"]

    subgraph Workers["Workers"]
        W1["Worker 1<br/>Self-play<br/>Kumpulkan trajectory"]
        W2["Worker 2<br/>Self-play<br/>Kumpulkan trajectory"]
        WN["Worker N<br/>Self-play<br/>Kumpulkan trajectory"]
    end

    W1 -->|Update gradien| Server
    W2 -->|Update gradien| Server
    WN -->|Update gradien| Server
    Server -->|Parameter terbaru| W1
    Server -->|Parameter terbaru| W2
    Server -->|Parameter terbaru| WN
```
