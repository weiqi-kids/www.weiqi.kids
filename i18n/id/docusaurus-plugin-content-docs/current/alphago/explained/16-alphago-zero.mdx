...
Kedua Head berbagi backbone ResNet yang sama (lihat [artikel berikutnya: Dual-Head Network dan Residual Network](../dual-head-resnet) untuk detail), ini membawa beberapa keuntungan:
...
- **Artikel Berikutnya**: [Dual-Head Network dan Residual Network](../dual-head-resnet) — Penjelasan detail arsitektur neural network AlphaGo Zero
- **Artikel Terkait**: [Self-Play](../self-play) — Mengapa self-play bisa menghasilkan level superhuman
- **Teknis Mendalam**: [Proses Pelatihan dari Nol](../training-from-scratch) — Evolusi detail Hari 0-3
