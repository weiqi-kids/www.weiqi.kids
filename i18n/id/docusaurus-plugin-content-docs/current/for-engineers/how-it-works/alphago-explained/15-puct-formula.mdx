...
- **Artikel Berikutnya**: [Ikhtisar AlphaGo Zero](./16-alphago-zero) — Terobosan dari nol
- **Artikel Sebelumnya**: [Kombinasi MCTS dan Neural Network](./14-mcts-neural-combo) — Arsitektur keseluruhan
- **Terkait**: [Batas Metode Tradisional](./05-traditional-limits) — Mengapa butuh metode baru
