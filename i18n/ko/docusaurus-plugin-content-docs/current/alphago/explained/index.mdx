...
본 시리즈 글은 [109개 애니메이션 개념](/docs/tech/how-it-works/concepts/)의 다음 시리즈를 참조합니다:
...
- [KataGo의 핵심 혁신](/docs/tech/how-it-works/katago-innovations) — 더 적은 리소스로 더 강한 기력 달성 방법
- [개념 빠른 참조표](/docs/tech/how-it-works/concepts/) — 109개 애니메이션 개념 전체 목록
- [30분 만에 첫 바둑 AI 실행하기](/docs/tech/hands-on/) — 직접 실습
