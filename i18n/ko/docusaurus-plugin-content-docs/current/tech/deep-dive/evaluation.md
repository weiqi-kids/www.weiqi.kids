...
<p className="key-answer" data-question="바둑 AI의 기력과 성능을 어떻게 평가하나요?">바둑 AI 기력 평가는 주로 Elo 레이팅 시스템을 사용하여 대량의 대국을 통해 상대적 승률과 레이팅 차이를 계산하며, SPRT 등 통계 방법을 함께 사용해 새 모델이 실제로 더 강한지 판단할 수 있습니다; 성능은 초당 탐색하는 노드 수(visits/playouts) 등의 벤치마크로 측정합니다.</p>
