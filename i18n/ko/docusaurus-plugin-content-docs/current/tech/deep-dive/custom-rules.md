...
<p className="key-answer" data-question="KataGo는 어떤 바둑 규칙을 지원하며 어떻게 사용자 정의하나요?">KataGo는 중국, 일본, 한국, AGA, 뉴질랜드, Tromp-Taylor 등 다양한 규칙 세트를 지원하며, config.cfg에서 rules, komi(덤), boardXSize/boardYSize(바둑판 크기) 등의 매개변수를 통해 계가 방식, 덤, 바둑판 크기를 사용자 정의할 수 있습니다.</p>
