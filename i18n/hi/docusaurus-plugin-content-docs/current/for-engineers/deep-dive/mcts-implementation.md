...
├─────────────────────────────────────────────────────┤
│                                                     │
│   1. Selection      चयन: ट्री में नीचे जाएं, PUCT से नोड चुनें  │
│         │                                           │
│         ▼                                           │
│   2. Expansion      विस्तार: लीफ नोड पर पहुंचें, चाइल्ड नोड बनाएं    │
│         │                                           │
│         ▼                                           │
│   3. Evaluation     मूल्यांकन: न्यूरल नेटवर्क से लीफ नोड का मूल्यांकन      │
│         │                                           │
│         ▼                                           │
│   4. Backprop       बैकप्रोप: पथ पर सभी नोड्स के आंकड़े अपडेट करें    │
│                                                     │
│   हजारों बार दोहराएं, सबसे अधिक विज़िट वाली चाल चुनें                │
│                                                     │
└─────────────────────────────────────────────────────┘
```
