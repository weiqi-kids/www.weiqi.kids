...
│                                             │
│   Policy Network (SL)                       │
│   ├── इनपुट: बोर्ड स्थिति (48 फीचर प्लेन)        │
│   ├── आर्किटेक्चर: 13 लेयर CNN                       │
│   ├── आउटपुट: 361 स्थानों की प्रायिकता                │
│   └── प्रशिक्षण: 3 करोड़ मानव गेम रिकॉर्ड                 │
│                                             │
│   Policy Network (RL)                       │
│   ├── SL Policy से इनिशियलाइज़                   │
│   └── सेल्फ-प्ले रिइन्फोर्समेंट लर्निंग                      │
│                                             │
│   Value Network                             │
│   ├── इनपुट: बोर्ड स्थिति                        │
│   ├── आउटपुट: एकल जीत दर मान                      │
│   └── प्रशिक्षण: सेल्फ-प्ले से उत्पन्न स्थितियाँ              │
│                                             │
│   MCTS                                      │
│   ├── Policy Network से सर्च मार्गदर्शित            │
│   └── Value Network + Rollout से मूल्यांकन       │
│                                             │
└─────────────────────────────────────────────┘
```
...
```
यादृच्छिक नेटवर्क इनिशियलाइज़
    │
    ▼
┌─────────────────────────────┐
│  सेल्फ-प्ले से गेम रिकॉर्ड उत्पन्न           │ ←─┐
└──────────────┬──────────────┘   │
               │                   │
               ▼                   │
┌─────────────────────────────┐   │
│  न्यूरल नेटवर्क प्रशिक्षण               │   │
│  - Policy: क्रॉस-एंट्रॉपी मिनिमाइज़      │   │
│  - Value: MSE मिनिमाइज़        │   │
└──────────────┬──────────────┘   │
               │                   │
               ▼                   │
┌─────────────────────────────┐   │
│  नए नेटवर्क का मूल्यांकन                 │   │
│  अधिक मजबूत हो तो बदलें               │───┘
└─────────────────────────────┘
```
