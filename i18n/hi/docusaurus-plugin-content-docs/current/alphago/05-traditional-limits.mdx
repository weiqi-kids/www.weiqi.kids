...
```mermaid
flowchart TB
    subgraph Max["Max स्तर（मैं）"]
        A["-3"]
        B["+5"]
        C["+2"]
    end

    subgraph MinA["Min स्तर"]
        A1["-3"]
        A2["+7"]
        A3["+5"]
    end

    subgraph MinB["Min स्तर"]
        B1["+5"]
        B2["-2"]
        B3["+9"]
    end

    subgraph MinC["Min स्तर"]
        C1["+2"]
        C2["+1"]
        C3["+4"]
    end
...
```mermaid
flowchart TB
    A["Max नोड A<br/>（वर्तमान सर्वश्रेष्ठ α = +5）"]
    B1["शाखा 1<br/>मूल्यांकित, मान = +5"]
    B["शाखा 2：Min नोड B"]
    C1["उप-शाखा B1：मान = +3"]
    C2["उप-शाखा B2：？？？<br/>（छोड़ सकते हैं!）"]
