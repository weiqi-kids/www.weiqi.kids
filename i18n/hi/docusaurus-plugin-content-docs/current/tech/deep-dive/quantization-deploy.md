...
<p className="key-answer" data-question="KataGo मॉडल को कैसे क्वांटाइज़ और डिप्लॉय करें?">क्वांटाइज़ेशन संख्यात्मक प्रिसिजन घटाकर मॉडल का आकार कम करता है और इन्फरेंस तेज़ करता है: FP16 लगभग बिना सटीकता हानि के आधी मेमोरी बचाता है, और INT8 इसे एक-चौथाई तक संपीड़ित कर देता है। क्वांटाइज़ेशन के दो तरीके हैं, प्रशिक्षण-पश्चात क्वांटाइज़ेशन (PTQ, सरल और तेज़) तथा क्वांटाइज़ेशन-अवेयर ट्रेनिंग (QAT, अधिक सटीक पर पुनः प्रशिक्षण आवश्यक), और फिर TensorRT जैसे उपकरणों के साथ विभिन्न प्लेटफॉर्मों पर डिप्लॉय किया जाता है।</p>
...
```mermaid
flowchart TB
    subgraph PTQ["पोस्ट-ट्रेनिंग क्वांटाइज़ेशन (PTQ)"]
        P1["सरल और तेज"]
        P2["रीट्रेनिंग आवश्यक नहीं"]
        P3["सटीकता हानि संभव"]
    end

    subgraph QAT["क्वांटाइज़ेशन-अवेयर ट्रेनिंग (QAT)"]
        Q1["उच्च सटीकता"]
        Q2["रीट्रेनिंग आवश्यक"]
        Q3["अपेक्षाकृत जटिल"]
    end
```
