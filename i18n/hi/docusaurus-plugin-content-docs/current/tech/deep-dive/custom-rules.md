...
<p className="key-answer" data-question="KataGo किन गो नियमों का समर्थन करता है और इन्हें कैसे कस्टमाइज़ करें?">KataGo चीनी, जापानी, कोरियाई, AGA, न्यूज़ीलैंड, Tromp-Taylor जैसे कई नियम सेट का समर्थन करता है, और config.cfg में rules, komi (कोमी), boardXSize/boardYSize (बोर्ड आकार) जैसे पैरामीटर के माध्यम से स्कोरिंग विधि, कोमी और बोर्ड आकार को कस्टमाइज़ किया जा सकता है।</p>
