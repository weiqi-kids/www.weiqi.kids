...
<p className="key-answer" data-question="KataGo का न्यूरल नेटवर्क आर्किटेक्चर क्या है?">KataGo एकल न्यूरल नेटवर्क और मल्टी-हेड आउटपुट का डिज़ाइन अपनाता है: मुख्य आधार के रूप में रेसिडुअल टावर (20 से 60 रेसिडुअल ब्लॉक तथा ग्लोबल पूलिंग लेयर) इनपुट फीचर प्लेन से फीचर निकालता है, और फिर Policy (चाल की प्रायिकता), Value (जीत दर), Score (अंकों का अंतर) तथा Ownership (क्षेत्र का स्वामित्व) इन चार आउटपुट हेड में विभाजित होता है।</p>
