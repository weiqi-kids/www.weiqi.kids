...
```mermaid
flowchart TB
    PS["Parameter Server<br/>(armazena θ mais recente,<br/>recebe atualizações de gradiente)"]

    W1["Worker 1<br/>autopartida<br/>coletar trajetórias"]
    W2["Worker 2<br/>autopartida<br/>coletar trajetórias"]
    WN["Worker N<br/>autopartida<br/>coletar trajetórias"]

    PS -->|"parâmetros mais recentes"| W1
    PS -->|"parâmetros mais recentes"| W2
    PS -->|"parâmetros mais recentes"| WN

    W1 -->|"atualizações de gradiente"| PS
    W2 -->|"atualizações de gradiente"| PS
    WN -->|"atualizações de gradiente"| PS
```
