...
Esta série de artigos referencia as seguintes séries dos [109 conceitos de animação](/docs/tech/how-it-works/concepts/):
...
- [Tabela de Referência Rápida de Conceitos](/docs/tech/how-it-works/concepts/) — Lista completa dos 109 conceitos de animação
