...
Esta série de artigos referencia as seguintes séries dos [109 conceitos de animação](../concepts/):
...
- [Inovações Chave do KataGo](../katago-innovations) — Como alcançar maior força com menos recursos
- [Tabela de Referência Rápida de Conceitos](../concepts/) — Lista completa dos 109 conceitos de animação
- [Execute Sua Primeira IA de Go em 30 Minutos](../../hands-on/) — Prática hands-on
