...
| Posição pedra preta \ branca | 1 | 2 | 3 |
|------------------------------|-----|-----|-----|
| **1** | +0,3 | -0,1 | +0,2 |
| **2** | -0,2 | +0,5 | -0,3 |
| **3** | +0,1 | -0,2 | +0,4 |
...
```mermaid
flowchart TB
    Shared["Camadas compartilhadas de<br/>extração de características"]
    Shared --> PolicyHead["Cabeça Policy"]
    Shared --> ValueHead["Cabeça Value"]
    PolicyHead --> PolicyOut["361 probabilidades"]
    ValueHead --> ValueOut["Valor único"]
```
