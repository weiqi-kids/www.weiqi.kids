...
本シリーズの記事は [109 個のアニメーション概念](../concepts/) の以下のシリーズを引用しています：
...
- [KataGo の重要なイノベーション](../katago-innovations) — より少ないリソースでより強い棋力を実現する方法
- [概念クイックリファレンス](../concepts/) — 109 個のアニメーション概念の完全リスト
- [30 分で初めての囲碁 AI を動かす](../../hands-on/) — ハンズオン実践
