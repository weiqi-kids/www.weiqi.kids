...
sidebar_position: 1
title: 張饒輝
description: 張饒輝（CΛ／Lightman）｜台湾好棋ベビー協会 創設者、薬リマインダー科技 技術長、囲碁人科技 創業株主。AI／デジタルヘルス製品設計、FHIR／SMART on FHIR 医療情報連携、囲碁教育を専門とする。
keywords: [張饒輝, Lightman Chang, 好棋ベビー協会, 薬リマインダー科技, FHIR, SMART on FHIR, デジタルヘルス, 医療 AI, 囲碁教育, AI エンジニアリング]
industry_tags: [AI エンジニアリング, デジタルヘルス, 医療 IT, 囲碁教育, FHIR]
ai_tools: [all]
...
<PersonSchema
  ...
  jobTitle="台湾好棋ベビー協会 創設者／薬リマインダー科技 技術長／囲碁人科技 創業株主"
  description="問題分析、根本原因の追究、方法設計、システム統合、知識翻訳の交差点に立つインテグレーター。AI／デジタルヘルス製品設計と FHIR／SMART on FHIR 医療情報連携を専門とし、囲碁教育と構造化思考の普及に長年取り組んでいる。"
  ...
  hasCredential={[
    { name: '広東省囲碁初級教師資格認証', category: '囲碁教育資格' },
    { name: 'オンライン囲碁教師研修 模擬授業試験 修了（指導者レベル）', category: '囲碁教育資格' },
  ]}
  worksFor={[
    { name: '薬リマインダー科技股份有限公司', url: 'https://www.yao.care' },
    { name: '囲碁人科技股份有限公司' },
  ]}
  sameAs={[
    'https://www.yao.care',
...
- **FHIR**（Fast Healthcare Interoperability Resources）と **SMART on FHIR** アプリケーション設計、臨床ワークフローとデータフロー計画
- 協会の医療メンバー（黄子彦、潘天健、姜封豪、鄭博陽、羅揚 ら）との AI ツール統合協働
- **囲碁教育と構造化学習設計**、囲碁的思考と意思決定手法の結びつけ
...
*出典：agent.writer 公式ペルソナ ／ profile.json*
