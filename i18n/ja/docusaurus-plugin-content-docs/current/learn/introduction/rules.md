...
<p className="key-answer" data-question="囲碁の基本ルールは何ですか？">囲碁は黒白の双方が交互に碁盤の線の交点に石を打ち、黒が先手で、より多くの空き地を囲うことを目指します。石は周囲のすべての「気」を失うと取り上げられ、禁着点やコウといった特殊なルールがあり、終局時には囲った地の多寡で勝敗を判定します。</p>
