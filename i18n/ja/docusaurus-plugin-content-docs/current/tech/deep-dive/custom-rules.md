...
<p className="key-answer" data-question="KataGoはどんな囲碁ルールをサポートし、どうカスタマイズしますか？">KataGoは中国、日本、韓国、AGA、ニュージーランド、Tromp-Taylorなど多様なルールセットをサポートしており、config.cfg内でrules、komi（コミ）、boardXSize／boardYSize（盤面サイズ）などのパラメータを通じて、地の数え方、コミ、盤面サイズをカスタマイズできます。</p>
