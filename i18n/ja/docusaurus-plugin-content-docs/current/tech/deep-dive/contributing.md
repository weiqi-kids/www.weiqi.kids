...
<p className="key-answer" data-question="KataGoのオープンソースコミュニティにどう参加しますか？">KataGoへの参加には主に四つの方法があります。分散訓練ネットワーク（katagotraining.org）にGPU計算能力を貢献する、GitHubで問題を報告する、ドキュメントを改善する、そしてC++／Pythonのコードを貢献することです。最も敷居が低いのは、GPU搭載のパソコンで自己対局を実行して計算能力を貢献する方法です。</p>
